function [E,V] = normlapheat(DATA,lodim,nn,step,stepsbtwnreport,opts)

% LAPHEAT Normalized Laplacian Eigenmaps Algorithm with Heat Kernel weights.
%
% [E,V] = normlapheat(DATA,lodim,[nn,step,stepsbtwnreport])
%
