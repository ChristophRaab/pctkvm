...
% This script calculates the kullback leibler divergence (KLD)
% and maximum mean discrepancy (MMD) for the 18 datasets
% Credits of source code:
% KLD: https://github.com/pberkes/neuro-kl
% MMD: http://www.gatsby.ucl.ac.uk/~gretton/mmd/mmd.htm
