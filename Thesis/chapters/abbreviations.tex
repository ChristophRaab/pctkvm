...
\acro{EM}{Expactation-Maximization}
\acro{EMG}{Myoelectric}
\acro{ERR}{Error}
...
\acro{PCTKVM}{Probabilistic Classifcation Transfer Kernel  Vector Machine}
\acro{PCVM}{Probabilistic Classification Vector Machine}
\acro{PSD}{Positive Semidefinite Kernel}
