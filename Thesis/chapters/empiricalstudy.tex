...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{%
		...
		\end{tabular}
	\caption[Comparison of Number of Support Vectors]{The mean of support vectors of a classifier for Reuters and Image datasets. The numbers on the right side of the datasets are the mean number of points over the six text sets and the twelve image sets. This is the result of 60 runs on text sets and 120 runs on image sets.\label{TableMeanNSV}}}
\end{table}
\FloatBarrier
